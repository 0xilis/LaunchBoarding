...
- (void)viewDidAppear:(BOOL)animated {
    ...
    //TODO: This is a hacky workaround because the animation doesn't start if we do it too early, figure out how to properly do it rather than just hoping this will be late enough later
    if (!self.welcomeLayer.animationKeys.count) {
